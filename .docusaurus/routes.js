...
export default [
  ...
  {
    path: '/docs',
    component: ComponentCreator('/docs','631'),
    routes: [
      {
      ...
      {
        path: '/docs/snippets/python-snippets',
        component: ComponentCreator('/docs/snippets/python-snippets','c1b'),
        exact: true,
        'sidebar': "tutorialSidebar"
      },
      {
        path: '/docs/snippets/unix-shell-snippets',
        component: ComponentCreator('/docs/snippets/unix-shell-snippets','ac9'),
        exact: true,
        'sidebar': "tutorialSidebar"
      },
      {
